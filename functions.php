...
//        }
        ...
        if (php_uname('s') == 'Linux') {
                ...
                $con = new PDO("mysql:host=localhost;dbname=prakweb_2024_C_223040093", "root", "");
        }
    ...
    function initDB() {
        ...
        if (php_uname('s') == 'Linux') {
            ...
            $command = "mysql -h localhost -u 'root' -p < \"D:\akdmk\kbm\smt5\pw\prakweb_2024_C_223040093\initDB.sql\"";
        }
